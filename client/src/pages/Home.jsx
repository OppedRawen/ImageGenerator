        ...
        <section className='max-w-7x1 mx-auto'>
            ...
            <div className='mt-10'>
                {loading?(
                    ...
                    <div className='grid lg:grid-cols-4 sm:grid-cols-3 x3:grid-cols-2 grid-cols-1 gap-3'>
                        {searchText?(<RenderCards data={searchedResults} title="No search results font" />):(<RenderCards data={allPosts} title="No posts found"/>)}
                    </div>
                    </>
                )}
            </div>
